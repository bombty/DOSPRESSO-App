...
**Rol Kodu**: `stajyer`  
**Kategori**: BRANCH  
**Aktif Kullanıcı Sayısı**: 42  
**Görev**: Eğitim odaklı, gözlem ve temel görev, akademi ilerleme, sınırlı operasyon.
...
> **Not**: Eğitim odaklı, gözlem ve temel görev, akademi ilerleme, sınırlı operasyon.
...
✅ 42 aktif kullanıcı pilotta yer alacak.
