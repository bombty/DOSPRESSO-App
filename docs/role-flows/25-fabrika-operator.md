# Fabrika Operatörü
**Rol Kodu**: `fabrika_operator`  
**Kategori**: FACTORY  
**Aktif Kullanıcı Sayısı**: 6  
**Görev**: Hat üretim, kalite check-in, atık raporlama, vardiya kiosk girişi.
...
> **Not**: Hat üretim, kalite check-in, atık raporlama, vardiya kiosk girişi.
...
✅ 6 aktif kullanıcı pilotta yer alacak.
