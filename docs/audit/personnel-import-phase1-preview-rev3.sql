-- ============================================================
-- DOSPRESSO — PERSONEL IMPORT PHASE 1 SQL PREVIEW (REV3)
-- Tarih: 28 Nisan 2026
...
-- ════════════════════════════════════════════════════════════
-- PHASE 6 — POST-VERIFICATION (REV3: 8 SELECT)
-- ════════════════════════════════════════════════════════════
...
-- (REV2 dry-run'da B4 yüzünden 9 satır gelmişti — REV3'te 10 olmalı)
...
--   net_salary=50000.00      (önceki: 4900000 — owner Excel ile karşılaştırmalı, R5)
--   updated_at = transaction zamanı

-- ════════════════════════════════════════════════════════════
-- COMMIT vs ROLLBACK — DRY-RUN modu (REV3)
-- ════════════════════════════════════════════════════════════
...
-- ============================================================
-- DOSYA SONU — Phase 1 SQL Preview REV3
