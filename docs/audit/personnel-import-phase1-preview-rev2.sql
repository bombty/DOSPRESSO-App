-- ============================================================
-- DOSPRESSO — PERSONEL IMPORT PHASE 1 SQL PREVIEW (REV2)
-- Tarih: 28 Nisan 2026
-- REV1: 28 Nis 2026 (BLOCKED — schema mismatch'leri vardı)
-- REV2: 28 Nis 2026 (B1+B2+B3 fix + R1+R4+R7 fix uygulandı)
...
-- ════════════════════════════════════════════════════════════
-- PHASE 6 — POST-VERIFICATION (REV2: 6 SELECT)
-- ════════════════════════════════════════════════════════════
-- Beklenen sonrası (REV2 GERÇEK):
--   Önceki = 46 user, soft-delete edilen 36 (zaten pasifler dahil), eklenen 36
--   = 46 + 36 = 82 toplam
--   Aktif beklenen = 35 yeni aktif + 10 korunan (UPDATE'lenenler dahil) - 1 Buğra
--                  = 44 aktif
...
--    çift sayım yok — toplam 82'de bir kere sayılıyor)
...
-- ============================================================
-- DOSYA SONU — Phase 1 SQL Preview REV2
