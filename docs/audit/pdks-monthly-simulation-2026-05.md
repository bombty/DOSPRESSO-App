...
**Çalıştırma tarihi:** 2026-05-03T01:05:16.884Z
...
**Kapsam filtresi:** Aktif + approved + !deleted + role NOT IN (admin, sube_kiosk, yatirimci_branch, yatirimci_hq, ceo, cgo) + first_name NOT ILIKE 'TEST%' + username NOT ILIKE 'test%' + last_name NOT ILIKE 'Kiosk' (Fabrika Kiosk vb. tüm kiosk hesaplarını kapsar).

## 1. Veri Sağlığı Özeti

| Metrik | Değer |
|---|---|
| Payroll kapsamındaki personel | 144 |
...
- A5: 114 payroll personeli için employee_salaries kaydı yok — bordro hesaplanamaz.
...
| Devamsız (gün) | 0 |
| Maaş bilgisi olan personel | 30 / 144 |
| Anomali bayrağı olan personel | 114 |
| Tahmini toplam brüt (mesai dahil) | 0,00 ₺ |
| Tahmini toplam ücretsiz izin kesintisi | 0,00 ₺ |
| Tahmini toplam (brüt − ücretsiz izin kesintisi, vergi/SGK hariç) | 0,00 ₺ |

## 4. Personel Bazlı Detay (günlük çalışma saati ortalaması dahil)

| Ad Soyad | Şube | Rol | Çalışılan Gün | Ort. Saat/Gün | F.Mesai | Üc.İzin | Rap.İzin | Yıl.İzin | Devamsız | Brüt | Tahmini Brüt | Üc.İzin Kesinti | Net (brüt−kesinti) | Anomali |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Berkan Bozdağ | Antalya Lara | bar_buddy | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 31.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Efe Yüksel | Antalya Lara | bar_buddy | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | — | — | — | — | 1× |
| Gül Demir | Antalya Lara | bar_buddy | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 31.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Adem Kara | Konya Bosna | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | — | — | — | — | 1× |
| Ahmet Hamit Doğan | Işıklar | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 31.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Ali Demirci | Antalya Beachpark | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | — | — | — | — | 1× |
| Ateş Güney Yılmaz | Işıklar | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 32.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Aylin Yılmaz | Gaziantep Üniversite | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | — | — | — | — | 1× |
| Ayten Erbaş | Kilis | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | — | — | — | — | 1× |
| Basri Şen | Işıklar | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 35.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
...
| Cihan Kolakan | Işıklar | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 32.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Cihan Yılmaz | Samsun Atakum | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | — | — | — | — | 1× |
| Deniz Ayvazoğlu | Antalya Lara | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | — | — | — | — | 1× |
| Dilara Jennefer Elmas | Antalya Lara | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 31.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
...
| Efe Kadir Kocakaya | Işıklar | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 31.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Emre Kaplan | Gaziantep İbnisina | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | — | — | — | — | 1× |
| Eren Demir | Antalya Lara | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 31.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
...
| Hülya Tüzün | Işıklar | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 31.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Hüseyin Çınar | Konya Bosna | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | — | — | — | — | 1× |
| Kemal Hüseyinoğlu | Işıklar | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 32.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
...
| Süleyman Olgun | Işıklar | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 32.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
...
| Veysel Hüseyinoğlu | Antalya Lara | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 31.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
...
| İsmail Sivri | Işıklar | barista | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 31.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
...
| Yavuz Kolakan | Merkez Ofis (HQ) | coach | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 46.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Ayşe Kaya | — | destek | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | — | — | — | — | 1× |
| Eren Elmas | Fabrika | fabrika_mudur | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | — | — | — | — | 1× |
| Arife Yıldırım | Fabrika | fabrika_operator | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 29.500,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Büşra Doğmuş | Fabrika | fabrika_operator | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 31.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Filiz Karali | Fabrika | fabrika_operator | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 30.500,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Galip Can Boran | Fabrika | fabrika_operator | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 31.500,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Hatice Kocabaş | Fabrika | fabrika_operator | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 31.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Leyla Sönmez | Fabrika | fabrika_operator | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 30.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Mihrican Veziroğlu | Fabrika | fabrika_operator | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 31.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Mustafa Can Horzum | Fabrika | fabrika_operator | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 39.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Ümüt Koşar | Fabrika | fabrika_operator | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 70.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
...
| Dıana Nayfonova | Merkez Ofis (HQ) | marketing | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 37.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
...
| Mahmut Altunay | Merkez Ofis (HQ) | muhasebe_ik | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 49.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Mahmut İK | — | muhasebe_ik | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | — | — | — | — | 1× |
| Samet Satinalma | — | satinalma | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | — | — | — | — | 1× |
| Şevket Samet Kara | Merkez Ofis (HQ) | satinalma | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 37.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Ümit Usta | Fabrika | sef | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | — | — | — | — | 1× |
| Alican Erkenekli | Antalya Lara | stajyer | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 33.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
| Yağız Törer | Antalya Lara | stajyer | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | — | — | — | — | 1× |
| Şahin Berker Ersürmeli | Antalya Lara | stajyer | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 33.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
...
| Ece Öz | Merkez Ofis (HQ) | trainer | 0 | 0s 0d | 0s 0d | 0 | 0 | 0 | 0 | 42.000,00 ₺ | 0,00 ₺ | 0,00 ₺ | 0,00 ₺ | — |
...
- Maaş bilgisi olan personel oranı 20.8% < %90.
- A5: 114 payroll personeli için employee_salaries kaydı yok — bordro hesaplanamaz.
