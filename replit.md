...
- **Recipe Management System**: Supports 14 categories and 55+ recipes with two cup sizes, separate measurements/steps, and automatic version tracking. Includes AI Recipe Creation via photo or text parsing.
