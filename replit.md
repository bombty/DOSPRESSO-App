...
- **Procurement Management System**: Complete procurement module with Dashboard, Inventory, Supplier Management, Purchase Orders, and Goods Receipt. CGO/CEO/Admin approval roles, branch-based order filtering for HQ roles.
