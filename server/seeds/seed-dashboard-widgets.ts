...
const WIDGET_REGISTRY = [
  { widgetKey: "branch_status", title: "Şube Durumu", dataSource: "branch_status", type: "kpi", size: "medium", category: "operasyon", componentKey: "BranchStatusWidget", description: "Toplam şube sayısı ve aktif şube durumu", sortOrder: 1 },
  ...
  { widgetKey: "staff_overview", title: "Personel Özeti", dataSource: "staff_count", type: "kpi", size: "medium", category: "personel", componentKey: "StaffOverviewWidget", description: "Aktif ve onaylı personel sayıları", sortOrder: 5 },
  { widgetKey: "leave_tracker", title: "İzin Takip", dataSource: "pending_leaves", type: "kpi", size: "small", category: "personel", componentKey: "LeaveTrackerWidget", description: "Bekleyen izin ve mesai talepleri", sortOrder: 6 },
  ...
  { widgetKey: "factory_production", title: "Fabrika Üretim", dataSource: "factory_production", type: "chart", size: "large", category: "fabrika", componentKey: "FactoryProductionWidget", description: "Üretim istatistikleri ve günlük çıktılar", sortOrder: 8 },
  ...
  { widgetKey: "financial_overview", title: "Finansal Özet", dataSource: "financial_overview", type: "chart", size: "large", category: "finans", componentKey: "FinancialOverviewWidget", description: "Gelir, gider ve net kar özeti", sortOrder: 11 },
  ...
  { widgetKey: "training_progress", title: "Eğitim İlerlemesi", dataSource: "training_progress", type: "chart", size: "medium", category: "egitim", componentKey: "TrainingProgressWidget", description: "Toplam kurs ve aktif kayıt sayıları", sortOrder: 13 },
  ...
  { widgetKey: "crm_summary", title: "CRM Özeti", dataSource: "crm_summary", type: "detail", size: "medium", category: "musteri", componentKey: "CRMSummaryWidget", description: "İletişim ve kampanya durumu", sortOrder: 15 },
  { widgetKey: "equipment_faults", title: "Ekipman Arızaları", dataSource: "equipment_faults", type: "kpi", size: "small", category: "ekipman", componentKey: "EquipmentFaultsWidget", description: "Açık arıza ve kritik arıza sayıları", sortOrder: 16 },
  { widgetKey: "equipment_maintenance", title: "Ekipman Bakım", dataSource: "equipment_maintenance", type: "kpi", size: "small", category: "ekipman", componentKey: "EquipmentMaintenanceWidget", description: "Planlı bakım ve geciken bakım sayıları", sortOrder: 17 },
  ...
  { widgetKey: "quick_actions", title: "Hızlı İşlemler", dataSource: "quick_actions_data", type: "actions", size: "medium", category: "genel", componentKey: "QuickActionsWidget", description: "Role özel hızlı eylem kısayolları", sortOrder: 19 },
];

const ROLE_WIDGET_MAPPINGS: Record<string, { keys: string[]; }> = {
  ceo: {
    keys: ["branch_status","sla_tracker","open_tickets","todays_tasks","staff_overview","financial_overview","factory_production","customer_feedback","equipment_faults","training_progress","ai_briefing","crm_summary","quick_actions"],
  },
  cgo: {
    keys: ["branch_status","sla_tracker","todays_tasks","staff_overview","financial_overview","customer_feedback","training_progress","equipment_faults","crm_summary","quick_actions"],
  },
  admin: {
    keys: ["branch_status","sla_tracker","open_tickets","todays_tasks","staff_overview","leave_tracker","ik_summary","factory_production","qc_stats","pending_shipments","financial_overview","pending_orders","training_progress","customer_feedback","crm_summary","equipment_faults","equipment_maintenance","quick_actions"],
  },
  satinalma: {
  ...
  muhasebe: {
    keys: ["financial_overview","pending_orders","todays_tasks","staff_overview","leave_tracker","quick_actions"],
  },
  muhasebe_ik: {
    keys: ["ik_summary","staff_overview","leave_tracker","financial_overview","todays_tasks","pending_orders","quick_actions"],
  },
  coach: {
    keys: ["todays_tasks","training_progress","staff_overview","customer_feedback","quick_actions"],
  },
  trainer: {
    keys: ["training_progress","todays_tasks","staff_overview","customer_feedback","quick_actions"],
  },
};
