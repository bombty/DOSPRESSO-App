...
import mrDobodyHammaddeEksiklikRouter from "./routes/mr-dobody-hammadde-eksiklik";  // Aslan 7 May 2026: AI eksikleri uyarmıyor talebi (severity-sorted veri eksikliği raporu)
...
function resetKioskRateLimit(identifier: string): void { kioskLoginAttempts.delete(identifier); }
  ...
  app.use(mrDobodyHammaddeEksiklikRouter);  // Aslan 7 May 2026: /api/mr-dobody/hammadde-eksiklik-raporu (severity-sorted)
