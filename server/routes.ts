...
import nutritionSyncRouter from "./routes/nutrition-sync";  // Sprint 14 Phase 11 (7 May 2026): rawMaterials → factoryIngredientNutrition senkronizasyon
...
function resetKioskRateLimit(identifier: string): void { kioskLoginAttempts.delete(identifier); }
  ...
  app.use(nutritionSyncRouter);  // Sprint 14 Phase 11 (7 May 2026): /api/nutrition-sync/* (besin akışı senkronizasyon)
