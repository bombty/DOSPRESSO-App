...
EQUIPMENT_TYPES = [
    {"key": "espresso", "name": "Espresso Makinesi (Thermoplan)", "default_count": 1},
    {"key": "krema", "name": "Krema Makinesi", "default_count": 1},
    {"key": "mixer", "name": "Bar Mikseri (Artemis)", "default_count": 1},
    {"key": "blender", "name": "Blender (Blendtech)", "default_count": 1},
    {"key": "cash", "name": "Kasa Sistemi", "default_count": 1},
    {"key": "kiosk", "name": "Kiosk Sistemi", "default_count": 1},
    {"key": "tea", "name": "Çay Makinesi", "default_count": 1},
    {"key": "ice", "name": "Buz Makinesi (Manitowock)", "default_count": 1},
    {"key": "filtre_kahve", "name": "Filtre Kahve Makinesi", "default_count": 1},
    {"key": "turk_kahve", "name": "Türk Kahvesi Makinesi", "default_count": 1},
    {"key": "donut_teshir", "name": "Donut Teşhir Dolabı", "default_count": 1},
    {"key": "positive_teshir", "name": "+4 Teşhir Dolabı (Soğutmalı)", "default_count": 1},
    {"key": "notr_teshir", "name": "Nötr Teşhir Dolabı (Oda Sıcaklığı)", "default_count": 1},
    {"key": "teshir_set", "name": "Teşhir Dolabı Set", "default_count": 1},
    {"key": "firin", "name": "Fırın", "default_count": 1},
    {"key": "hizli_firin", "name": "Hızlı Fırın", "default_count": 1},
    {"key": "tost", "name": "Tost Makinesi", "default_count": 1},
]
