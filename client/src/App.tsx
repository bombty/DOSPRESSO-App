...
const BranchOnboardingAdmin = lazyWithRetry(() => import("@/pages/branch-recipes/onboarding-admin"));
    ...
    <Switch>
      ...
      {isAuthenticated && (
        <>
          ...
          <Route path="/branch-recipes/admin/onboarding">{() => <BranchOnboardingAdmin />}</Route>
