...
const FabrikaKaliteKontrol = lazyWithRetry(() => import("@/pages/fabrika/kalite-kontrol"));
const FabrikaPerformans = lazyWithRetry(() => import("@/pages/fabrika/performans"));
const FabrikaAIRaporlar = lazyWithRetry(() => import("@/pages/fabrika/ai-raporlar"));
const FabrikaUretimPlanlama = lazyWithRetry(() => import("@/pages/fabrika/uretim-planlama"));
const FabrikaVardiyaUyumluluk = lazyWithRetry(() => import("@/pages/fabrika/vardiya-uyumluluk"));
...
const AdminAktiviteLoglar = lazyWithRetry(() => import("@/pages/admin/aktivite-loglari"));
const AdminYedekleme = lazyWithRetry(() => import("@/pages/admin/yedekleme"));
const AdminKullanicilar = lazyWithRetry(() => import("@/pages/admin/kullanicilar"));
...
const AdminKaliteDenetimSablonuDuzenle = lazyWithRetry(() => import("@/pages/admin/kalite-denetim-sablonu-duzenle"));
    ...
    <Switch>
      ...
      {isAuthenticated && (
        <>
          ...
          <Route path="/iletisim-merkezi">{() => { window.location.replace("/hq-destek"); return null; }}</Route>
        </>
      )}
