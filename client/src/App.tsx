      ...
      {isAuthenticated && (
        <>
          ...
          <Route path="/supplier-allergen-forms">
            {() => <ProtectedRoute allowedRoles={["admin","ceo","cgo","satinalma","gida_muhendisi","kalite_kontrol","kalite_yoneticisi","fabrika_mudur"]}><SupplierAllergenForms /></ProtectedRoute>}
          </Route>
