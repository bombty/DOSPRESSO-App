import {
  ...
  Home, Wallet, Headphones, Megaphone, GraduationCap, Lock, AlertTriangle,
} from "lucide-react";
...
const FABRIKA_MENU: ModuleMenuConfig = {
  ...
  items: [
    ...
    { id: "mr-dobody-eksiklik", label: "🤖 Mr. Dobody Eksiklik Raporu", path: "/mr-dobody/hammadde-eksiklik", icon: AlertTriangle, allowedRoles: ["admin","ceo","cgo","satinalma","gida_muhendisi","kalite_kontrol","kalite_yoneticisi"] },
...
const EXACT_ROUTE_MAP: Record<string, ModuleMenuConfig> = {
  ...
  "/girdi-yonetimi": FABRIKA_MENU,
  "/etiket-hesapla": FABRIKA_MENU,
  "/tedarikci-kalite": FABRIKA_MENU,
  "/turkomp": FABRIKA_MENU,
