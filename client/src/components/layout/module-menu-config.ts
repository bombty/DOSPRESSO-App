import {
  Users, Clock, CreditCard, Calendar, FileText, Shield, ShieldCheck, UserPlus,
...
const FABRIKA_MENU: ModuleMenuConfig = {
  ...
  items: [
    ...
    { id: "saf", label: "🛡️ Tedarikçi Alerjen Formu", path: "/supplier-allergen-forms", icon: ShieldCheck, allowedRoles: ["admin","ceo","cgo","satinalma","gida_muhendisi","kalite_kontrol","kalite_yoneticisi","fabrika_mudur"] },
