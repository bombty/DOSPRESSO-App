...
export default function MissionControlCoach() {
  ...
  if (isLoading) {
    return (
      <div className="p-4 space-y-4 max-w-[1400px] mx-auto" data-testid="mc-coach-loading">
  ...
  return (
    <div className="p-3 md:p-4 space-y-3 max-w-[1400px] mx-auto overflow-y-auto h-full" data-testid="mission-control-coach">
