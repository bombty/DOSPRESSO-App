...
export default function FranchiseOzet() {
  ...
  return (
      <div className="p-4 space-y-4 max-w-6xl mx-auto" data-testid="franchise-ozet-loading">
  ...
  if (!data) {
    return (
      <div className="p-4 max-w-6xl mx-auto" data-testid="franchise-ozet-error">
  ...
  return (
    <div className="p-4 space-y-4 max-w-6xl mx-auto overflow-y-auto h-full" data-testid="franchise-ozet-page">
      <DobodyFlowMode
        userId={user?.id || ""}
        userRole={user?.role || ""}
