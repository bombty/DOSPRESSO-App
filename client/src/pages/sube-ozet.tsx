...
export default function SubeOzet() {
  ...
  if (isLoading) {
    return (
      <div className="p-3 sm:p-4 space-y-3 sm:space-y-4 max-w-lg md:max-w-2xl mx-auto" data-testid="sube-ozet-loading">
  ...
  if (!data) {
    return (
      <div className="p-3 sm:p-4 max-w-lg md:max-w-2xl mx-auto" data-testid="sube-ozet-error">
  ...
  return (
    <div className="p-3 sm:p-4 space-y-3 sm:space-y-4 max-w-lg md:max-w-2xl mx-auto overflow-y-auto h-full" data-testid="sube-ozet-page">
      <DobodyFlowMode
        userId={user?.id || ""}
        userRole={user?.role || ""}
